...
# Por que usar:
# Organiza dependências → Ajuda em projetos grandes com vários arquivos .c.
# Compila apenas arquivos modificados → Evita recompilar tudo do zero.
# Facilita a compilação → Não precisa lembrar comandos longos de gcc.
# Automatiza tarefas → Pode rodar testes, limpar arquivos, etc.
